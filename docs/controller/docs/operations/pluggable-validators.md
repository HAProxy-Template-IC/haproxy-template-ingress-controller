...
Any program that conforms to the [wire protocol](../../../development/validator-protocol.md) can be substituted. The protocol is intentionally narrow:
