...
- [Helm Chart Values](https://gitlab.com/haproxy-template-ic/haproxy-template-ingress-controller/blob/main/charts/haproxy-template-ic/values.yaml) - Production deployment examples
