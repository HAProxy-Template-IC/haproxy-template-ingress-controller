...
Full documentation: [haproxy-haptic.org/docs](https://haproxy-haptic.org/docs/0.2.0/) (this chart's pages live under *Deploying with Helm*).
...
The full values reference lives in [Chart Values Reference](https://haproxy-haptic.org/docs/0.2.0/reference/). The ones operators most commonly change:
...
Each library contributes entries under `watchedResources`, `templateSnippets`, `maps`, `files`, `sslCertificates`, `haproxyConfig`, and `validationTests` — user-provided values in `controller.config` override library defaults. See [Template Libraries](https://haproxy-haptic.org/docs/0.2.0/template-libraries/) for the library-merging design, extension points, and snippet priority ranges.

## Documentation

| Area | Where to look |
|------|---------------|
| Getting started | [Getting Started](https://haproxy-haptic.org/docs/0.2.0/getting-started/), [Deploying with Helm](https://haproxy-haptic.org/docs/0.2.0/deploying-with-helm/) |
| Ingress & Gateway setup | [IngressClass](https://haproxy-haptic.org/docs/0.2.0/ingress-class/), [GatewayClass](https://haproxy-haptic.org/docs/0.2.0/gateway-class/) |
| SSL and annotations | [SSL Certificates](https://haproxy-haptic.org/docs/0.2.0/ssl-certificates/), [Annotations](https://haproxy-haptic.org/docs/0.2.0/annotations/) |
| Running HAProxy | [HAProxy Deployment](https://haproxy-haptic.org/docs/0.2.0/haproxy-deployment/) |
| Library reference | [Template Libraries](https://haproxy-haptic.org/docs/0.2.0/template-libraries/) |
| Day-two operations | [High Availability](https://haproxy-haptic.org/docs/0.2.0/operations/high-availability/), [Monitoring](https://haproxy-haptic.org/docs/0.2.0/operations/monitoring/), [Networking](https://haproxy-haptic.org/docs/0.2.0/operations/networking/), [Debugging](https://haproxy-haptic.org/docs/0.2.0/operations/debugging/), [Troubleshooting](https://haproxy-haptic.org/docs/0.2.0/troubleshooting/) |
| Full values reference | [Chart Values Reference](https://haproxy-haptic.org/docs/0.2.0/reference/) |
