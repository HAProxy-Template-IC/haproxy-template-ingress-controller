...
type HAProxyTemplateConfigSpec struct {
	...
	// by the playground's migration report, which reads it from a build-time
	// chart render — no entry influences rendering or reconciliation, and
	// nothing in a cluster reads the stored copy.
	//
