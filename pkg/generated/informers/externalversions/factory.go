...
type SharedInformerFactory interface {
	...
	HaproxyTemplateIC() haproxytemplate.Interface
}

func (f *sharedInformerFactory) HaproxyTemplateIC() haproxytemplate.Interface {
	return haproxytemplate.New(f, f.namespace, f.tweakListOptions)
}
