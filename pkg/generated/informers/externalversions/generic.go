...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("haproxytemplatelibraries"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.HaproxyTemplateIC().V1alpha1().HAProxyTemplateLibraries().Informer()}, nil
