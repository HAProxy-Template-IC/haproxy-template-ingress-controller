...
func validateBackendHTTPRules(cv *validators.CachedValidator, backend *models.Backend, name string) []string {
	var errors []string
	errors = appendIndexedErrors(errors, backend.HTTPRequestRuleList, cv.ValidateHTTPRequestRule, name, "http-request rule")
	errors = appendIndexedErrors(errors, backend.HTTPResponseRuleList, cv.ValidateHTTPResponseRule, name, "http-response rule")
	errors = appendIndexedErrors(errors, backend.HTTPAfterResponseRuleList, cv.ValidateHTTPAfterResponseRule, name, "http-after-response rule")
	errors = appendIndexedErrors(errors, backend.HTTPErrorRuleList, cv.ValidateHTTPErrorRule, name, "http-error rule")
	return errors
}
...
func validateBackendTCPRules(cv *validators.CachedValidator, backend *models.Backend, name string) []string {
	var errors []string
	errors = appendIndexedErrors(errors, backend.TCPRequestRuleList, cv.ValidateTCPRequestRule, name, "tcp-request rule")
	errors = appendIndexedErrors(errors, backend.TCPResponseRuleList, cv.ValidateTCPResponseRule, name, "tcp-response rule")
	return errors
}
...
func validateBackendMiscRules(cv *validators.CachedValidator, backend *models.Backend, name string) []string {
	var errors []string
	errors = appendIndexedErrors(errors, backend.ServerSwitchingRuleList, cv.ValidateServerSwitchingRule, name, "server switching rule")
	errors = appendIndexedErrors(errors, backend.StickRuleList, cv.ValidateStickRule, name, "stick rule")
	errors = appendIndexedErrors(errors, backend.ACLList, cv.ValidateACL, name, "ACL")
	errors = appendIndexedErrors(errors, backend.FilterList, cv.ValidateFilter, name, "filter")
	errors = appendIndexedErrors(errors, backend.LogTargetList, cv.ValidateLogTarget, name, "log target")
	return errors
}
...
func validateBackendChecksGenerated(cv *validators.CachedValidator, backend *models.Backend) []string {
	var errors []string
	name := "backend " + backend.Name
	errors = appendIndexedErrors(errors, backend.HTTPCheckList, cv.ValidateHTTPCheck, name, "http-check")
	errors = appendIndexedErrors(errors, backend.TCPCheckRuleList, cv.ValidateTCPCheck, name, "tcp-check")
	return errors
}
...
func validateFrontendHTTPRules(cv *validators.CachedValidator, frontend *models.Frontend, name string) []string {
	var errors []string
	errors = appendIndexedErrors(errors, frontend.HTTPRequestRuleList, cv.ValidateHTTPRequestRule, name, "http-request rule")
	errors = appendIndexedErrors(errors, frontend.HTTPResponseRuleList, cv.ValidateHTTPResponseRule, name, "http-response rule")
	errors = appendIndexedErrors(errors, frontend.HTTPAfterResponseRuleList, cv.ValidateHTTPAfterResponseRule, name, "http-after-response rule")
	errors = appendIndexedErrors(errors, frontend.HTTPErrorRuleList, cv.ValidateHTTPErrorRule, name, "http-error rule")
	return errors
}
...
func validateFrontendOtherRules(cv *validators.CachedValidator, frontend *models.Frontend, name string) []string {
	var errors []string
	errors = appendIndexedErrors(errors, frontend.TCPRequestRuleList, cv.ValidateTCPRequestRule, name, "tcp-request rule")
	errors = appendIndexedErrors(errors, frontend.BackendSwitchingRuleList, cv.ValidateBackendSwitchingRule, name, "backend switching rule")
	errors = appendIndexedErrors(errors, frontend.ACLList, cv.ValidateACL, name, "ACL")
	return errors
}
...
func validateFrontendElementsGenerated(cv *validators.CachedValidator, frontend *models.Frontend) []string {
	var errors []string
	name := "frontend " + frontend.Name
	errors = appendIndexedErrors(errors, frontend.FilterList, cv.ValidateFilter, name, "filter")
	errors = appendIndexedErrors(errors, frontend.LogTargetList, cv.ValidateLogTarget, name, "log target")
	errors = appendIndexedErrors(errors, frontend.CaptureList, cv.ValidateCapture, name, "capture")
	return errors
}
