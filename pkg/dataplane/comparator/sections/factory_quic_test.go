...
func TestQUICInitialRuleFactoryFunctions(t *testing.T) {
	...
	tests := []struct {
		...
		// Frontend variants
		{
			name:             "QuicInitialRuleFrontendOps.Create",
			factory:          QuicInitialRuleFrontendOps.Create,
			parentName:       "https",
			index:            0,
		...
		{
			name:             "QuicInitialRuleFrontendOps.Update",
			factory:          QuicInitialRuleFrontendOps.Update,
			parentName:       "https",
			index:            2,
		...
		{
			name:       "QuicInitialRuleFrontendOps.Delete",
			factory:    QuicInitialRuleFrontendOps.Delete,
			parentName: "https",
			index:      1,
		...
		// Defaults variants
		{
			name:             "QuicInitialRuleDefaultsOps.Create",
			factory:          QuicInitialRuleDefaultsOps.Create,
			parentName:       "common",
			index:            0,
			wantType:         OperationCreate,
		...
		{
			name:             "QuicInitialRuleDefaultsOps.Update",
			factory:          QuicInitialRuleDefaultsOps.Update,
			parentName:       "common",
			index:            5,
			wantType:         OperationUpdate,
		...
		{
			name:             "QuicInitialRuleDefaultsOps.Delete",
			factory:          QuicInitialRuleDefaultsOps.Delete,
			parentName:       "common",
			index:            3,
			wantType:         OperationDelete,
