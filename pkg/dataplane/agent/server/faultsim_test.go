...
var faults = []fault{
	...
	},
	{
		...
		arm: func(s *simulation, _ *api.Manifest, _ []file) {
			s.h.model.With(func(m *agenttest.Model) { m.ReloadFails = true })
		},
		disarm: func(s *simulation) {
			s.h.model.With(func(m *agenttest.Model) { m.ReloadFails = false })
		},
	},
	{
		...
		arm: func(s *simulation, m *api.Manifest, _ []file) {
			...
			s.h.model.With(func(model *agenttest.Model) {
		...
		disarm: func(s *simulation) {
			s.h.model.With(func(model *agenttest.Model) { model.Reject = nil })
		},
	},
	{
	...
	},
	{
		...
		arm: func(s *simulation, _ *api.Manifest, _ []file) {
			s.h.model.With(func(m *agenttest.Model) { m.Pid += 3 })
		},
		disarm: func(*simulation) {},
	},
	{
