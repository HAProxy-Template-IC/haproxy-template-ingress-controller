...
`DefaultDebounceInterval` (5 seconds) lives in this package as the canonical default for `WatcherConfig.DebounceInterval` — referenced from both `pkg/k8s` callers and the user-facing performance docs.
