...
This is a thin event-loop on top of `pkg/controller/component.Base` — same scaffold used by `credentialsloader`. The actual parsing lives in `pkg/controller/conversion`; this package just wires the event flow.
...
- [`pkg/controller/component`](../component/) — shared event-loop scaffold
