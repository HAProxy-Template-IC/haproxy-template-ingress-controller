...
func TestRunner_AssertNotContains(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result := runner.assertNotContains(tt.content, nil, nil, assertion, "")
...
func TestRunner_AssertNotContains_WithDescription(t *testing.T) {
	...
	result := runner.assertNotContains("hello world", nil, nil, assertion, "")
...
func TestRunner_AssertMatchCount(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result := runner.assertMatchCount(tt.content, nil, nil, assertion, "")
...
func TestRunner_AssertEquals(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result := runner.assertEquals(tt.content, nil, nil, assertion, "")
...
func TestRunner_AssertEquals_TruncatesLongValues(t *testing.T) {
	...
	result := runner.assertEquals(longContent, nil, nil, assertion, "")
...
func TestRunner_AssertMatchOrder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result := runner.assertMatchOrder(tt.content, nil, nil, assertion, "")
...
func TestRunner_ResolveTarget(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := runner.resolveTarget(tt.target, haproxyConfig, auxFiles, k8sResources, renderError)
			assert.Equal(t, tt.want, got)
		})
	}
}
