...
func TestRunAssertion(t *testing.T) {
	...
	t.Run("contains assertion", func(t *testing.T) {
		...
		result := runner.runAssertion(ctx, assertion, haproxyConfig, nil, nil, nil, "", nil, nil)
	...
	t.Run("jsonpath assertion", func(t *testing.T) {
		...
		result := runner.runAssertion(ctx, assertion, haproxyConfig, nil, nil, templateCtx, "", nil, nil)
		assert.True(t, result.Passed)
...
func TestAssertContains(t *testing.T) {
	...
	t.Run("invalid regex pattern", func(t *testing.T) {
		...
		result := runner.assertContains("frontend test", nil, nil, assertion, "")
		assert.False(t, result.Passed)
	...
	t.Run("default description when empty", func(t *testing.T) {
		...
		result := runner.assertContains("test", nil, nil, assertion, "")
		assert.True(t, result.Passed)
	...
	t.Run("targets rendering_error", func(t *testing.T) {
		...
		result := runner.assertContains("", nil, nil, assertion, "Service 'api' not found")
		assert.True(t, result.Passed)
	})
}
...
func TestAssertDeterministic(t *testing.T) {
	...
	t.Run("missing render dependencies fails", func(t *testing.T) {
		...
		result := runner.runAssertion(ctx, assertion, "test config", nil, nil, nil, "", nil, nil)
