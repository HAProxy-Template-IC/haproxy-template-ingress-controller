...
func (d *Discovery) evaluatePod(
	...
	if podIP == "" {
		return Candidate{Reason: RejectionNoPodIP, Endpoint: dataplane.Endpoint{
			PodName: pod.GetName(), PodNamespace: pod.GetNamespace(), PodUID: string(pod.GetUID()),
		}}, true, nil
	}
